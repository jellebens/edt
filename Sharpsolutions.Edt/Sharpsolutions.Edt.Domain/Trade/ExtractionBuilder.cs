namespace Sharpsolutions.Edt.Domain.Trade
{
    public class ExtractionBuilder : StarportBuilderBase
    {
        protected override void AddGoods(Starport starport)
        {
            ...
            starport.Add("Explosives", "Chemicals", false, true);
            ...
            starport.Add("Mineral Extractors", "Machinery", false, true);
            starport.Add("Heliostatic Furnaces", "Machinery", false, false);
            starport.Add("Basic Medicines", "Medicines", false, true);
            starport.Add("Progenitor Cells", "Medicines", false, false);
            starport.Add("Combat Stabilisers", "Medicines", false, false);
            starport.Add("Performance Enhancers", "Medicines", false, false);
            starport.Add("Palladium", "Metals", true, false);
            starport.Add("Silver", "Metals", true, false);
            starport.Add("Gold", "Metals", true, false);
            ...
            starport.Add("Gallite", "Minerals", true, false);
            starport.Add("Indite", "Minerals", true, false);
            starport.Add("Uraninite", "Minerals", true, false);
            starport.Add("Bertrandite", "Minerals", true, false);
            starport.Add("Coltan", "Minerals", true, false);
            starport.Add("Bauxite", "Minerals", true, false);
            starport.Add("Rutile", "Minerals", true, false);
            starport.Add("HE Suits", "Technology", false, true);
            starport.Add("Bio Reducing Lichen", "Technology", false, true);
